...
#else
	.setup          = composite_composite_setup,
	.reset          = composite_composite_disconnect,
	.disconnect     = composite_composite_disconnect,
#endif
	.suspend	= composite_composite_suspend,
	.resume		= composite_composite_resume,
